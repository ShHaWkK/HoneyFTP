...
class HoneyFTP(ftp.FTP):
    ...
    def ftp_RETR(self, path):
        ...
        if rel == self.token:
            logging.info("TOKEN DL %s session=%s", rel, self.session)
